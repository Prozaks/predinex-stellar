...
/**
 * Claim-status values mirroring the `ClaimStatus` enum in the Soroban contract.
 */
 ...
 * Falls back to an off-chain fan-out aggregation when the contract ID is not
 * configured (e.g. test/dev without a deployed contract).
 *
 * @param userAddress - Stellar account address (`G...` strkey).
